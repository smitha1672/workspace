...
int
Solution::findRadius(std::vector<int>& houses, std::vector<int>& heaters)
{
...
main(void)
{
    int _nums1[] = {1,2,3};
    int _nums2[] = {2};
    std::vector<int>houses(_nums1, _nums1+(sizeof(_nums1)/sizeof(_nums1[0])));
    std::vector<int>heaters(_nums2, _nums2+(sizeof(_nums2)/sizeof(_nums2[0])));
    Solution s;
